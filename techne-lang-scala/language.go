...
//
// metals is the Scala server every editor outside IntelliJ runs. It
// imports the build before it can answer anything, which for a cold
// project is the slowest first question of any server declared here.
//
