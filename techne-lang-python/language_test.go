...
func TestLanguage(t *testing.T) {
	...
	t.Run("Declaration", func(t *testing.T) {
		...
		t.Run("claims the wire form this module owns", func(t *testing.T) {
			t.Parallel()
			assert.Equal(t, string(python.Declaration().Language), "python",
		...
		t.Run("claims .py", func(t *testing.T) {
			t.Parallel()
			assert.Contains(t, python.Declaration().Extensions, ".py",
