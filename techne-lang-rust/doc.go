...
// Package rust declares the Rust language:
//
//   - its extension, project manifests, comment forms and test files
//   - its tree-sitter grammar and tags query
//   - rust-analyzer, its language server
//
// A composition root calls [Register], which adds Rust to a registry and
...
// Rust. It does not import another language module.
package rust
